...
app.controller('defaultCtrl', ['$scope', '$http', function ($scope, $http){
    ...
    $scope.subHeadingText = "Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui.";
    ...
    $scope.subHeadingTitle = "Sub Heading";
    ...
    $http.get('Data/bodyData.json').then((response)=>{
